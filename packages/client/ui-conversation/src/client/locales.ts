...
export const zh = {
  ...
  'chat.toBottom': '回到底部',
  'chat.process': '过程',
  'chat.process.current': '当前过程',
  'chat.process.warning': '过程有异常',
  'chat.process.steps.one': '{n} 步',
  'chat.process.steps.other': '{n} 步',
  'chat.process.previousStages': '先前阶段',
  'chat.process.details': '运行详情',
  'chat.process.result': '阶段结果',
  'chat.activity.log': '运行过程',
  'chat.activity.starting': '正在获取第一个执行信号',
  'chat.activity.compacting': '正在整理已有上下文',
  'chat.activity.retrying': '正在重连模型',
...
export const en = {
  ...
  'chat.process.current': 'Current process',
  'chat.process.warning': 'Process needs attention',
  'chat.process.steps.one': '{n} step',
  'chat.process.steps.other': '{n} steps',
  'chat.process.previousStages': 'Previous stages',
  'chat.process.details': 'Run details',
  'chat.process.result': 'Stage result',
  'chat.activity.log': 'Run activity',
  'chat.activity.starting': 'Waiting for the first execution signal',
  'chat.activity.compacting': 'Organizing existing context',
  'chat.activity.retrying': 'Reconnecting to the model',
