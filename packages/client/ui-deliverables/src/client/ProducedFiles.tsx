...
// come pre-matched from structured mutation locations plus exact common
// artifact references in the closing answer. Clicking one goes through the
// same openFile the tool rows use — the Host's own opener, on the Host machine.
