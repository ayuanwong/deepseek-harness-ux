 ...
 * prose. All policy lives here — structured mutation locations, exact
 * closing-answer references for common artifacts, mention matching, the
 * chip cap, and the copy — so
...
export function apply(ctx: ClientContext): void {
  ...
  const mentions: ChatFileMentions = {
    forClosing(owner) {
      // Same claim test the turn-tail chain entry runs: no deliverable paths,
