...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  {
    key: 'webPresentation',
    summary: 'Host Remote service.',
    methods: [
      {
        signature: '@Remote(\'response-headings\') async responseHeadings(request: ResponseHeadingPresentationRequest): Promise<ResponseHeadingPresentationResult>',
      ...
      {
        signature: '@Remote(\'process-stage\') async processStage(request: ProcessStagePresentationRequest): Promise<ProcessStagePresentationResult>',
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'ProcessStagePresentationRequest',
    declaration: 'export interface ProcessStagePresentationRequest {\n    readonly sessionId: SessionId;\n    readonly turn: number;\n    readonly afterSeq: number;\n    readonly acceptedStages: readonly string[];\n}',
  },
  {
  ...
  {
    name: 'ResponseHeadingPresentationRequest',
    declaration: 'export interface ResponseHeadingPresentationRequest {\n    readonly sessionId: SessionId;\n    readonly messageId: MessageId;\n}',
  },
  {
    name: 'ResponseHeadingPresentationResult',
    declaration: 'export type ResponseHeadingPresentationResult = {\n    readonly kind: \'refined\';\n    readonly replacements: readonly ResponseHeadingReplacement[];\n} | {\n    readonly kind: \'unchanged\';\n} | {\n    readonly kind: \'unavailable\';\n    readonly reason: \'session-not-live\' | \'message-not-found\' | \'turn-not-closed\' | \'not-closing-message\' | \'route-unavailable\' | \'input-too-large\' | \'generation-failed\';\n};',
  },
  {
    name: 'ResponseHeadingReplacement',
    declaration: 'export interface ResponseHeadingReplacement {\n    readonly textBlock: number;\n    readonly offset: number;\n    readonly title: string;\n}',
  },
  {
