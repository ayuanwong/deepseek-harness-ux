...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ProcessStagePresentationRequest: 'web.md',
  ProcessStagePresentationResult: 'web.md',
  ResponseHeadingPresentationRequest: 'web.md',
  ResponseHeadingPresentationResult: 'web.md',
